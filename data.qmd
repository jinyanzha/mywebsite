...
```
CDC PLACES API ─┐
                ├─► join on 5-digit county FIPS ─► analytic dataset (N = 3,142)
Census ACS API ─┘
                                                   │
...
```{r tbl-cov-summary}
#| tbl-cap: "Summary statistics for the four ACS covariates (N = 3,142 counties)."
merged |>
  summarise(
